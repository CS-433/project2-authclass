from linear_search_function import *
import argparse
import yaml
...
path_to_input_file = '../../Data/Inputs/Linear_Search_Features/Input_SVM_PENALTY_'+args.Ninput+'.yaml'
path_to_output_file = '../../Data/Outputs/Linear_Search_Features/Output_HyperPara_SVM_PENALTY_'+args.Ninput+'.yaml'
...
result_all = change_one_parameter('cohort_all',config,X_train_all,X_test_all,y_train_all,y_test_all,var)
result_native = change_one_parameter('cohort_native',config,X_train_native,X_test_native,y_train_native,y_test_native,var)
result_nonnat = change_one_parameter('cohort_nonnat',config,X_train_nonnat,X_test_nonnat,y_train_nonnat,y_test_nonnat,var)
